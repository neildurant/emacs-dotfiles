...
(global-set-key (kbd "<f10>") '(lambda() (interactive) (switch-to-buffer "*Org Agenda(a)*")(delete-other-windows)))
...
(setq barf (get-string-from-file njn/html-export-css-template))
