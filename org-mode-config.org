...
#+begin_src emacs-lisp
  ...
  (setq njn/journal-org-file (concat personal-org-dir "/nate.org"))
  (setq njn/notes-org-file (concat personal-org-dir "/nate.org"))
  
#+end_src
* Remember 
** Keep clocks running if started from remember mode
   :PROPERTIES:
   :ID:       6B4E5193-54C1-4531-8D22-1CC6255045F3
   :END:
#+begin_src emacs-lisp
...
** Remember Templates
   :PROPERTIES:
   :ID:       D39D0B00-2A7A-48BC-9A5F-450627F69709
   :END:
#+begin_src emacs-lisp
...
** Tweaks
   :PROPERTIES:
   :ID:       FEDEAA2D-621D-47E5-9A31-12531D29EFC9
   :END:
#+begin_src emacs-lisp
